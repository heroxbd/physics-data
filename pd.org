...
** Python
   ...
   - 实践：安装 Python 3 环境。
     - GNU/Linux: 原生
     - Mac OS: 原生, macports, Gentoo Prefix, Homebrew
     - Windows: 原生, WSL, VirtualBox, Hyper-V
** 版本控制
   - “我上周写的程序被不小心覆盖掉了！无法找回之前的版本。”
   - “我和同学合写文章，结果他是在昨天的版本上改的！我还得重改！”
*** 发展历史
    - 石器时代 :: 实验报告-v1, 实验报告-v2, 实验报告-v2.2, 实验报
              告-v2.2改, 实验报告-v2.2改-续本达更新20190629……
