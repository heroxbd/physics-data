...
**** 内建手册 =man=                                          :B_exampleblock:
 ...
 $ man git add
     #+END_EXAMPLE
*** 作业：Git 练习
    - 你会在 [[https://git.tsinghua.edu.cn][清华 GitLab]] 收到一个新仓库，是今天的作业
    - 设置本地到 [[https://git.tsinghua.edu.cn][清华 GitLab]] 的访问权限
      - 生成 SSH 密钥对
...
*** Git 仓库间通信的种种形态
    ...
    - pull request :: GitLab 平台术语，发送 merge 请求
...
** git commit                                               :B_ignoreheading:
   ...
   #+BEGIN_EXPORT latex
\frame[plain]{\includegraphics[page=8,height=\textheight]{fig/git-commit.pdf}}
\frame[plain]{\includegraphics[page=9,height=\textheight]{fig/git-commit.pdf}}
\frame[plain]{\includegraphics[page=10,height=\textheight]{fig/git-commit.pdf}}
\frame[plain]{\includegraphics[page=11,height=\textheight]{fig/git-commit.pdf}}
   #+END_EXPORT
