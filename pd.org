...
*** 实例演示
    [[http://hep.tsinghua.edu.cn/~berrysoft/bdeph2022/lectures/notebooks/Python-Basics.slides.html][演示文稿传送门]]
** Python 的程序结构
*** 程序结构
    [[http://hep.tsinghua.edu.cn/~berrysoft/bdeph2022/lectures/notebooks/Python-Constructs.slides.html][演示文稿传送门]]
