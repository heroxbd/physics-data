# 课程名
  ...
  * 实验物理的大数据方法（2），40320842，32学时， 2019年7月15日~26日
    * 可选应用实践，2019年7月29日~8月2日
...
# 评分形式
  ...
  * 课内和日常作业采用 jupyter 的 nbgrader.
    每次作业 4 分，平时作业共计 60 分。
  * 每周的数据任务，采用 git + Makefile
    `make test` 测试点计分

    每个任务根据难度，有10分、20分、30分几档，大作业得分不设上限。
